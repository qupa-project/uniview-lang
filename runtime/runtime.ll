; ModuleID = 'runtime/runtime.cpp'
source_filename = "runtime/runtime.cpp"
...
$"?put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DN@Z" = comdat any
...
@11 = private unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"??_R4failure@ios_base@std@@6B@" to i8*), i8* bitcast (i8* (%"class.std::ios_base::failure"*, i32)* @"??_Gfailure@ios_base@std@@UEAAPEAXI@Z" to i8*), i8* bitcast (i8* (%"class.std::exception"*)* @"?what@exception@std@@UEBAPEBDXZ" to i8*)] }, comdat($"??_7failure@ios_base@std@@6B@")
...
@12 = private unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"??_R4system_error@std@@6B@" to i8*), i8* bitcast (i8* (%"class.std::system_error"*, i32)* @"??_Gsystem_error@std@@UEAAPEAXI@Z" to i8*), i8* bitcast (i8* (%"class.std::exception"*)* @"?what@exception@std@@UEBAPEBDXZ" to i8*)] }, comdat($"??_7system_error@std@@6B@")
...
@13 = private unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"??_R4_System_error@std@@6B@" to i8*), i8* bitcast (i8* (%"class.std::_System_error"*, i32)* @"??_G_System_error@std@@UEAAPEAXI@Z" to i8*), i8* bitcast (i8* (%"class.std::exception"*)* @"?what@exception@std@@UEBAPEBDXZ" to i8*)] }, comdat($"??_7_System_error@std@@6B@")
...
@14 = private unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* bitcast (%rtti.CompleteObjectLocator* @"??_R4runtime_error@std@@6B@" to i8*), i8* bitcast (i8* (%"class.std::runtime_error"*, i32)* @"??_Gruntime_error@std@@UEAAPEAXI@Z" to i8*), i8* bitcast (i8* (%"class.std::exception"*)* @"?what@exception@std@@UEBAPEBDXZ" to i8*)] }, comdat($"??_7runtime_error@std@@6B@")
...
@"??_7_Iostream_error_category2@std@@6B@" = unnamed_addr alias i8*, getelementptr inbounds ({ [7 x i8*] }, { [7 x i8*] }* @10, i32 0, i32 0, i32 1)
@"??_7failure@ios_base@std@@6B@" = unnamed_addr alias i8*, getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @11, i32 0, i32 0, i32 1)
@"??_7system_error@std@@6B@" = unnamed_addr alias i8*, getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @12, i32 0, i32 0, i32 1)
@"??_7_System_error@std@@6B@" = unnamed_addr alias i8*, getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @13, i32 0, i32 0, i32 1)
@"??_7runtime_error@std@@6B@" = unnamed_addr alias i8*, getelementptr inbounds ({ [3 x i8*] }, { [3 x i8*] }* @14, i32 0, i32 0, i32 1)

; Function Attrs: noinline optnone uwtable
define dso_local void @i32_print(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@H@Z"(%"class.std::basic_ostream"* @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i32 %3)
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@H@Z"(%"class.std::basic_ostream"* %0, i32 %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %14 = call %"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* @"??0sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@AEAV12@@Z"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6, %"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %13)
  %15 = invoke zeroext i1 @"??Bsentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEBA_NXZ"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6)
...
17:                                               ; preds = %16
  %18 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %25 = add nsw i64 0, %24
  %26 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %27 = getelementptr inbounds i8, i8* %26, i64 %25
  %28 = bitcast i8* %27 to %"class.std::ios_base"*
  invoke void @"?getloc@ios_base@std@@QEBA?AVlocale@2@XZ"(%"class.std::ios_base"* %28, %"class.std::locale"* sret align 8 %8)
          to label %29 unwind label %136

29:                                               ; preds = %17
  %30 = invoke nonnull align 8 dereferenceable(16) %"class.std::num_put"* @"??$use_facet@V?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAAEBV?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@AEBVlocale@0@@Z"(%"class.std::locale"* nonnull align 8 dereferenceable(16) %8)
          to label %31 unwind label %53

31:                                               ; preds = %29
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %8) #12
  store %"class.std::num_put"* %30, %"class.std::num_put"** %7, align 8
  %32 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %39 = add nsw i64 0, %38
  %40 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %41 = getelementptr inbounds i8, i8* %40, i64 %39
  %42 = bitcast i8* %41 to %"class.std::ios_base"*
  %43 = invoke i32 @"?flags@ios_base@std@@QEBAHXZ"(%"class.std::ios_base"* %42)
...
53:                                               ; preds = %29
  ...
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %8) #12 [ "funclet"(token %54) ]
  cleanupret from %54 unwind label %136
...
57:                                               ; preds = %55, %51
  %58 = load %"class.std::num_put"*, %"class.std::num_put"** %7, align 8
  %59 = load i32, i32* %10, align 4
  %60 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %67 = add nsw i64 0, %66
  %68 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %69 = getelementptr inbounds i8, i8* %68, i64 %67
  %70 = bitcast i8* %69 to %"class.std::basic_ios"*
  %71 = invoke i8 @"?fill@?$basic_ios@DU?$char_traits@D@std@@@std@@QEBADXZ"(%"class.std::basic_ios"* %70)
          to label %72 unwind label %98

72:                                               ; preds = %57
  %73 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %80 = add nsw i64 0, %79
  %81 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %82 = getelementptr inbounds i8, i8* %81, i64 %80
  %83 = bitcast i8* %82 to %"class.std::ios_base"*
  %84 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %91 = add nsw i64 0, %90
  %92 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %93 = getelementptr inbounds i8, i8* %92, i64 %91
  %94 = bitcast i8* %93 to %"class.std::basic_ios"*
  %95 = invoke %"class.std::basic_streambuf"* @"?rdbuf@?$basic_ios@DU?$char_traits@D@std@@@std@@QEBAPEAV?$basic_streambuf@DU?$char_traits@D@std@@@2@XZ"(%"class.std::basic_ios"* %94)
          to label %96 unwind label %98

96:                                               ; preds = %72
  %97 = call %"class.std::ostreambuf_iterator"* @"??0?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAA@PEAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z"(%"class.std::ostreambuf_iterator"* %12, %"class.std::basic_streambuf"* %95) #12
  invoke void @"?put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DJ@Z"(%"class.std::num_put"* %58, %"class.std::ostreambuf_iterator"* sret align 8 %11, %"class.std::ostreambuf_iterator"* %12, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %83, i8 %71, i32 %59)
          to label %116 unwind label %98

98:                                               ; preds = %96, %72, %57
  %99 = catchswitch within none [label %100] unwind label %136

100:                                              ; preds = %98
  %101 = catchpad within %99 [i8* null, i32 64, i8* null]
  %102 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %109 = add nsw i64 0, %108
  %110 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %111 = getelementptr inbounds i8, i8* %110, i64 %109
  %112 = bitcast i8* %111 to %"class.std::basic_ios"*
  invoke void @"?setstate@?$basic_ios@DU?$char_traits@D@std@@@std@@QEAAXH_N@Z"(%"class.std::basic_ios"* %112, i32 4, i1 zeroext true) [ "funclet"(token %101) ]
          to label %113 unwind label %136

113:                                              ; preds = %100
  catchret from %101 to label %114
...
116:                                              ; preds = %96
  %117 = call zeroext i1 @"?failed@?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEBA_NXZ"(%"class.std::ostreambuf_iterator"* %11) #12
...
122:                                              ; preds = %115, %16
  %123 = bitcast %"class.std::basic_ostream"* %13 to i8*
  ...
  %131 = bitcast %"class.std::basic_ostream"* %13 to i8*
  %132 = getelementptr inbounds i8, i8* %131, i64 %130
  %133 = bitcast i8* %132 to %"class.std::basic_ios"*
  %134 = load i32, i32* %5, align 4
  invoke void @"?setstate@?$basic_ios@DU?$char_traits@D@std@@@std@@QEAAXH_N@Z"(%"class.std::basic_ios"* %133, i32 %134, i1 zeroext false)
          to label %135 unwind label %136

135:                                              ; preds = %122
  call void @"??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@XZ"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6) #12
  ret %"class.std::basic_ostream"* %13

136:                                              ; preds = %122, %100, %98, %31, %53, %17, %2
  %137 = cleanuppad within none []
  call void @"??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@XZ"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6) #12 [ "funclet"(token %137) ]
  cleanupret from %137 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define dso_local void @i64_print(i64 %0) #0 {
  %2 = alloca i64, align 8
  store i64 %0, i64* %2, align 8
  %3 = load i64, i64* %2, align 8
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@_J@Z"(%"class.std::basic_ostream"* @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i64 %3)
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@_J@Z"(%"class.std::basic_ostream"* %0, i64 %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
...
68:                                               ; preds = %44
  %69 = call %"class.std::ostreambuf_iterator"* @"??0?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAA@PEAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z"(%"class.std::ostreambuf_iterator"* %10, %"class.std::basic_streambuf"* %67) #12
...
88:                                               ; preds = %68
  %89 = call zeroext i1 @"?failed@?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEBA_NXZ"(%"class.std::ostreambuf_iterator"* %9) #12
...
93:                                               ; preds = %27
  ...
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %8) #12 [ "funclet"(token %94) ]
...
110:                                              ; preds = %96, %72, %70, %93, %15, %2
  ...
  call void @"??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@XZ"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6) #12 [ "funclet"(token %111) ]
  cleanupret from %111 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define dso_local void @f32_print(float %0) #0 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  %3 = load float, float* %2, align 4
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@M@Z"(%"class.std::basic_ostream"* @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", float %3)
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@M@Z"(%"class.std::basic_ostream"* %0, float %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
...
29:                                               ; preds = %27
  ...
  %33 = bitcast %"class.std::basic_ostream"* %11 to i8*
  ...
  %40 = add nsw i64 0, %39
  %41 = bitcast %"class.std::basic_ostream"* %11 to i8*
  %42 = getelementptr inbounds i8, i8* %41, i64 %40
  %43 = bitcast i8* %42 to %"class.std::basic_ios"*
  %44 = invoke i8 @"?fill@?$basic_ios@DU?$char_traits@D@std@@@std@@QEBADXZ"(%"class.std::basic_ios"* %43)
          to label %45 unwind label %71

45:                                               ; preds = %29
  %46 = bitcast %"class.std::basic_ostream"* %11 to i8*
  ...
  %53 = add nsw i64 0, %52
  %54 = bitcast %"class.std::basic_ostream"* %11 to i8*
  %55 = getelementptr inbounds i8, i8* %54, i64 %53
  %56 = bitcast i8* %55 to %"class.std::ios_base"*
  %57 = bitcast %"class.std::basic_ostream"* %11 to i8*
  ...
  %64 = add nsw i64 0, %63
  %65 = bitcast %"class.std::basic_ostream"* %11 to i8*
  %66 = getelementptr inbounds i8, i8* %65, i64 %64
  %67 = bitcast i8* %66 to %"class.std::basic_ios"*
  %68 = invoke %"class.std::basic_streambuf"* @"?rdbuf@?$basic_ios@DU?$char_traits@D@std@@@std@@QEBAPEAV?$basic_streambuf@DU?$char_traits@D@std@@@2@XZ"(%"class.std::basic_ios"* %67)
          to label %69 unwind label %71

69:                                               ; preds = %45
  %70 = call %"class.std::ostreambuf_iterator"* @"??0?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAA@PEAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z"(%"class.std::ostreambuf_iterator"* %10, %"class.std::basic_streambuf"* %68) #12
  invoke void @"?put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DN@Z"(%"class.std::num_put"* %30, %"class.std::ostreambuf_iterator"* sret align 8 %9, %"class.std::ostreambuf_iterator"* %10, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %56, i8 %44, double %32)
          to label %89 unwind label %71

71:                                               ; preds = %69, %45, %29
  %72 = catchswitch within none [label %73] unwind label %111

73:                                               ; preds = %71
  %74 = catchpad within %72 [i8* null, i32 64, i8* null]
  %75 = bitcast %"class.std::basic_ostream"* %11 to i8*
  ...
  %82 = add nsw i64 0, %81
  %83 = bitcast %"class.std::basic_ostream"* %11 to i8*
  %84 = getelementptr inbounds i8, i8* %83, i64 %82
  %85 = bitcast i8* %84 to %"class.std::basic_ios"*
  invoke void @"?setstate@?$basic_ios@DU?$char_traits@D@std@@@std@@QEAAXH_N@Z"(%"class.std::basic_ios"* %85, i32 4, i1 zeroext true) [ "funclet"(token %74) ]
          to label %86 unwind label %111

86:                                               ; preds = %73
  catchret from %74 to label %87
...
89:                                               ; preds = %69
  %90 = call zeroext i1 @"?failed@?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEBA_NXZ"(%"class.std::ostreambuf_iterator"* %9) #12
...
94:                                               ; preds = %27
  ...
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %8) #12 [ "funclet"(token %95) ]
  cleanupret from %95 unwind label %111

96:                                               ; preds = %91, %89
  br label %88

97:                                               ; preds = %88, %14
  %98 = bitcast %"class.std::basic_ostream"* %11 to i8*
  ...
  %106 = bitcast %"class.std::basic_ostream"* %11 to i8*
  %107 = getelementptr inbounds i8, i8* %106, i64 %105
  %108 = bitcast i8* %107 to %"class.std::basic_ios"*
  %109 = load i32, i32* %5, align 4
  invoke void @"?setstate@?$basic_ios@DU?$char_traits@D@std@@@std@@QEAAXH_N@Z"(%"class.std::basic_ios"* %108, i32 %109, i1 zeroext false)
...
111:                                              ; preds = %97, %73, %71, %94, %15, %2
  %112 = cleanuppad within none []
  call void @"??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@XZ"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6) #12 [ "funclet"(token %112) ]
  cleanupret from %112 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define dso_local void @i1_print(i1 zeroext %0) #0 {
  %2 = alloca i8, align 1
  %3 = zext i1 %0 to i8
...
6:                                                ; preds = %1
  %7 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"??_C@_04LOAJBDKD@true?$AA@", i64 0, i64 0))
  br label %10

8:                                                ; preds = %1
  %9 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"??_C@_05LAPONLG@false?$AA@", i64 0, i64 0))
  br label %10
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %0, i8* %1) #0 comdat personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::basic_ostream"*, align 8
  %5 = alloca i32, align 4
...
; Function Attrs: noinline optnone uwtable
define dso_local void @str_print(i8* %0) #0 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  %3 = load i8*, i8** %2, align 8
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i8* %3)
  ret void
}

; Function Attrs: noinline optnone uwtable
define dso_local void @i32_println(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@H@Z"(%"class.std::basic_ostream"* @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i32 %3)
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z"(%"class.std::basic_ostream"* %4, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @"??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z")
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z"(%"class.std::basic_ostream"* %0, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* %1) #0 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %0) #0 comdat {
...
; Function Attrs: noinline optnone uwtable
define dso_local void @i64_println(i64 %0) #0 {
  %2 = alloca i64, align 8
  store i64 %0, i64* %2, align 8
  %3 = load i64, i64* %2, align 8
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@_J@Z"(%"class.std::basic_ostream"* @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i64 %3)
...
; Function Attrs: noinline optnone uwtable
define dso_local void @f32_println(float %0) #0 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  %3 = load float, float* %2, align 4
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@M@Z"(%"class.std::basic_ostream"* @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", float %3)
...
; Function Attrs: noinline optnone uwtable
define dso_local void @i1_println(i1 zeroext %0) #0 {
  %2 = alloca i8, align 1
  %3 = zext i1 %0 to i8
  store i8 %3, i8* %2, align 1
  %4 = load i8, i8* %2, align 1
...
6:                                                ; preds = %1
  %7 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i8* getelementptr inbounds ([5 x i8], [5 x i8]* @"??_C@_04LOAJBDKD@true?$AA@", i64 0, i64 0))
  %8 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z"(%"class.std::basic_ostream"* %7, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @"??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z")
  br label %12

9:                                                ; preds = %1
  %10 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i8* getelementptr inbounds ([6 x i8], [6 x i8]* @"??_C@_05LAPONLG@false?$AA@", i64 0, i64 0))
  %11 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??6?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV01@P6AAEAV01@AEAV01@@Z@Z"(%"class.std::basic_ostream"* %10, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @"??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z")
  br label %12
...
; Function Attrs: noinline optnone uwtable
define dso_local void @str_println(i8* %0) #0 {
  %2 = alloca i8*, align 8
  store i8* %0, i8** %2, align 8
  %3 = load i8*, i8** %2, align 8
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"??$?6U?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@PEBD@Z"(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @"?cout@std@@3V?$basic_ostream@DU?$char_traits@D@std@@@1@A", i8* %3)
...
define linkonce_odr dso_local void @"??__E?id@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@2V0locale@2@A@@YAXXZ"() #1 comdat {
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @"??__E?id@?$numpunct@D@std@@2V0locale@2@A@@YAXXZ"() #1 comdat {
  %1 = call %"class.std::locale::id"* @"??0id@locale@std@@QEAA@_K@Z"(%"class.std::locale::id"* @"?id@?$numpunct@D@std@@2V0locale@2@A", i64 0)
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* @"??0sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@AEAV12@@Z"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* returned %0, %"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DJ@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i32 %5) #0 comdat align 2 {
  %7 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.std::ostreambuf_iterator"* @"??0?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAA@PEAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z"(%"class.std::ostreambuf_iterator"* returned %0, %"class.std::basic_streambuf"* %1) unnamed_addr #2 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local zeroext i1 @"?failed@?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEBA_NXZ"(%"class.std::ostreambuf_iterator"* %0) #2 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?setstate@?$basic_ios@DU?$char_traits@D@std@@@std@@QEAAXH_N@Z"(%"class.std::basic_ios"* %0, i32 %1, i1 zeroext %2) #0 comdat align 2 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::basic_ostream<char, std::char_traits<char>>::_Sentry_base"* @"??0_Sentry_base@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@AEAV12@@Z"(%"class.std::basic_ostream<char, std::char_traits<char>>::_Sentry_base"* returned %0, %"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %1) unnamed_addr #0 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local zeroext i1 @"?good@ios_base@std@@QEBA_NXZ"(%"class.std::ios_base"* %0) #0 comdat align 2 {
  %2 = alloca %"class.std::ios_base"*, align 8
  store %"class.std::ios_base"* %0, %"class.std::ios_base"** %2, align 8
  %3 = load %"class.std::ios_base"*, %"class.std::ios_base"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"?flush@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV12@XZ"(%"class.std::basic_ostream"* %0) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.std::basic_ostream"*, align 8
  %3 = alloca %"class.std::basic_streambuf"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32 @"?pubsync@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QEAAHXZ"(%"class.std::basic_streambuf"* %0) #0 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::locale::facet"* @"?_Getfacet@locale@std@@QEBAPEBVfacet@12@_K@Z"(%"class.std::locale"* %0, i64 %1) #0 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i64 @"?_Getcat@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z"(%"class.std::locale::facet"** %0, %"class.std::locale"* %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
...
13:                                               ; preds = %9
  %14 = call noalias nonnull i8* @"??2@YAPEAX_K@Z"(i64 16) #19
...
define linkonce_odr dso_local void @"?_Throw_bad_cast@std@@YAXXZ"() #4 comdat {
  ...
  call void @_CxxThrowException(i8* %3, %eh.ThrowInfo* @"_TI2?AVbad_cast@std@@") #17
  unreachable
}
...
define linkonce_odr dso_local %"class.std::unique_ptr"* @"??$?0U?$default_delete@V_Facet_base@std@@@std@@$0A@@?$unique_ptr@V_Facet_base@std@@U?$default_delete@V_Facet_base@std@@@2@@std@@QEAA@PEAV_Facet_base@1@@Z"(%"class.std::unique_ptr"* returned %0, %"class.std::_Facet_base"* %1) unnamed_addr #2 comdat align 2 {
  ...
  %10 = call %"class.std::_Compressed_pair"* @"??$?0AEAPEAV_Facet_base@std@@@?$_Compressed_pair@U?$default_delete@V_Facet_base@std@@@std@@PEAV_Facet_base@2@$00@std@@QEAA@U_Zero_then_variadic_args_t@1@AEAPEAV_Facet_base@1@@Z"(%"class.std::_Compressed_pair"* %7, i8 %9, %"class.std::_Facet_base"** nonnull align 8 dereferenceable(8) %3) #12
  ret %"class.std::unique_ptr"* %6
}

declare dso_local void @"?_Facet_Register@std@@YAXPEAV_Facet_base@1@@Z"(%"class.std::_Facet_base"*) #5
...
8:                                                ; preds = %1
  ...
  %10 = call nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @"?_Get_first@?$_Compressed_pair@U?$default_delete@V_Facet_base@std@@@std@@PEAV_Facet_base@2@$00@std@@QEAAAEAU?$default_delete@V_Facet_base@std@@@2@XZ"(%"class.std::_Compressed_pair"* %9) #12
...
declare dso_local %"class.std::locale::_Locimp"* @"?_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ"() #5

; Function Attrs: nobuiltin allocsize(0)
declare dso_local nonnull i8* @"??2@YAPEAX_K@Z"(i64) #6
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::_Locinfo"* @"??0_Locinfo@std@@QEAA@PEBD@Z"(%"class.std::_Locinfo"* returned %0, i8* %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i8*, align 8
  ...
  %13 = call %"class.std::_Yarn.0"* @"??0?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %12) #12
  %14 = getelementptr inbounds %"class.std::_Locinfo", %"class.std::_Locinfo"* %5, i32 0, i32 4
  %15 = call %"class.std::_Yarn.0"* @"??0?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %14) #12
...
25:                                               ; preds = %2
  invoke void @"?_Xruntime_error@std@@YAXPEBD@Z"(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @"??_C@_0BA@ELKIONDK@bad?5locale?5name?$AA@", i64 0, i64 0)) #17
...
31:                                               ; preds = %29
  ...
  call void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %14) #12 [ "funclet"(token %32) ]
  cleanupret from %32 unwind label %33

33:                                               ; preds = %31
  %34 = cleanuppad within none []
  call void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %12) #12 [ "funclet"(token %34) ]
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::num_put"* @"??0?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEAA@AEBV_Locinfo@1@_K@Z"(%"class.std::num_put"* returned %0, %"class.std::_Locinfo"* nonnull align 8 dereferenceable(104) %1, i64 %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i64, align 8
  %5 = alloca %"class.std::_Locinfo"*, align 8
...
14:                                               ; preds = %3
  ...
  call void @"??1facet@locale@std@@MEAA@XZ"(%"class.std::locale::facet"* %16) #12 [ "funclet"(token %15) ]
...
4:                                                ; preds = %1
  ...
  call void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %7) #12
  %8 = getelementptr inbounds %"class.std::_Locinfo", %"class.std::_Locinfo"* %3, i32 0, i32 3
  call void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %8) #12
...
18:                                               ; preds = %15
  ...
  call void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %20) #12 [ "funclet"(token %19) ]
...
21:                                               ; preds = %18
  ...
  call void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %23) #12 [ "funclet"(token %22) ]
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.std::_Yarn.0"* @"??0?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* returned %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %"class.std::_Yarn.0"*, align 8
  store %"class.std::_Yarn.0"* %0, %"class.std::_Yarn.0"** %2, align 8
  %3 = load %"class.std::_Yarn.0"*, %"class.std::_Yarn.0"** %2, align 8
  %4 = getelementptr inbounds %"class.std::_Yarn.0", %"class.std::_Yarn.0"* %3, i32 0, i32 0
  store i16* null, i16** %4, align 8
  %5 = getelementptr inbounds %"class.std::_Yarn.0", %"class.std::_Yarn.0"* %3, i32 0, i32 1
  store i16 0, i16* %5, align 8
  ret %"class.std::_Yarn.0"* %3
}

declare dso_local void @"?_Locinfo_ctor@_Locinfo@std@@SAXPEAV12@PEBD@Z"(%"class.std::_Locinfo"*, i8*) #5
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??1?$_Yarn@_W@std@@QEAA@XZ"(%"class.std::_Yarn.0"* %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %"class.std::_Yarn.0"*, align 8
  store %"class.std::_Yarn.0"* %0, %"class.std::_Yarn.0"** %2, align 8
  %3 = load %"class.std::_Yarn.0"*, %"class.std::_Yarn.0"** %2, align 8
  call void @"?_Tidy@?$_Yarn@_W@std@@AEAAXXZ"(%"class.std::_Yarn.0"* %3) #12
  ret void
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"?_Tidy@?$_Yarn@_W@std@@AEAAXXZ"(%"class.std::_Yarn.0"* %0) #2 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.std::_Yarn.0"*, align 8
  store %"class.std::_Yarn.0"* %0, %"class.std::_Yarn.0"** %2, align 8
  %3 = load %"class.std::_Yarn.0"*, %"class.std::_Yarn.0"** %2, align 8
  %4 = getelementptr inbounds %"class.std::_Yarn.0", %"class.std::_Yarn.0"* %3, i32 0, i32 0
...
7:                                                ; preds = %1
  %8 = getelementptr inbounds %"class.std::_Yarn.0", %"class.std::_Yarn.0"* %3, i32 0, i32 0
...
12:                                               ; preds = %11, %1
  %13 = getelementptr inbounds %"class.std::_Yarn.0", %"class.std::_Yarn.0"* %3, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"?_Init@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@IEAAXAEBV_Locinfo@2@@Z"(%"class.std::num_put"* %0, %"class.std::_Locinfo"* nonnull align 8 dereferenceable(104) %1) #2 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"??_G?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEAAPEAXI@Z"(%"class.std::num_put"* %0, i32 %1) unnamed_addr #2 comdat align 2 {
  %3 = alloca i8*, align 8
  ...
  call void @"??1?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEAA@XZ"(%"class.std::num_put"* %6) #12
  %9 = icmp eq i32 %8, 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DPEBX@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i8* %5) unnamed_addr #0 comdat align 2 {
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DO@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, double %5) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %7 = alloca i8*, align 8
  ...
  %25 = call %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %12) #12
...
53:                                               ; preds = %48
  ...
  %55 = call double @fabsl(double %54) #21
  %56 = fcmp olt double 1.000000e+10, %55
  br i1 %56, label %57, label %67

57:                                               ; preds = %53
  %58 = load double, double* %8, align 8
  %59 = call double @frexpl(double %58, i32* %20) #12
  %60 = load i32, i32* %20, align 4
  %61 = call i32 @abs(i32 %60) #21
...
79:                                               ; preds = %76
  %80 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %12) #12
  %81 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %12, i64 0) #12
...
83:                                               ; preds = %79
  ...
  %86 = call i8* @"?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAPEBDXZ"(%"class.std::basic_string"* %12) #12
...
91:                                               ; preds = %83
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %12) #12
  ret void

92:                                               ; preds = %83, %79, %76, %70, %67, %43, %39, %6
  %93 = cleanuppad within none []
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %12) #12 [ "funclet"(token %93) ]
  cleanupret from %93 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DN@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, double %5) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %7 = alloca i8*, align 8
  %8 = alloca double, align 8
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
57:                                               ; preds = %53
  %58 = load double, double* %8, align 8
  %59 = call double @frexp(double %58, i32* %20) #12
  %60 = load i32, i32* %20, align 4
  %61 = call i32 @abs(i32 %60) #21
  %62 = mul nsw i32 %61, 30103
  %63 = sdiv i32 %62, 100000
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_K@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i64 %5) unnamed_addr #0 comdat align 2 {
  %7 = alloca i8*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_J@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i64 %5) unnamed_addr #0 comdat align 2 {
  %7 = alloca i8*, align 8
  %8 = alloca i64, align 8
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DK@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i32 %5) unnamed_addr #0 comdat align 2 {
  %7 = alloca i8*, align 8
  %8 = alloca i32, align 4
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DJ@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i32 %5) unnamed_addr #0 comdat align 2 {
  %7 = alloca i8*, align 8
  %8 = alloca i32, align 4
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_N@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i1 zeroext %5) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %7 = alloca i8*, align 8
  %8 = alloca i8, align 1
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
46:                                               ; preds = %43
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %14) #12
  store %"class.std::numpunct"* %45, %"class.std::numpunct"** %13, align 8
  %47 = call %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %15) #12
...
52:                                               ; preds = %50
  %53 = call nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@$$QEAV12@@Z"(%"class.std::basic_string"* %15, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %16) #12
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %16) #12
  br label %60

54:                                               ; preds = %43
  %55 = cleanuppad within none []
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %14) #12 [ "funclet"(token %55) ]
  cleanupret from %55 unwind to caller
...
58:                                               ; preds = %56
  %59 = call nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@$$QEAV12@@Z"(%"class.std::basic_string"* %15, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %17) #12
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %17) #12
  br label %60
...
68:                                               ; preds = %65
  %69 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %15) #12
...
75:                                               ; preds = %72
  %76 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %15) #12
  %77 = sub i64 %74, %76
...
92:                                               ; preds = %89, %81
  %93 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %15) #12
  %94 = call i8* @"?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAPEBDXZ"(%"class.std::basic_string"* %15) #12
...
107:                                              ; preds = %102
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %15) #12
  br label %110

108:                                              ; preds = %102, %97, %92, %84, %78, %72, %65, %60, %56, %50
  %109 = cleanuppad within none []
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %15) #12 [ "funclet"(token %109) ]
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??1?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEAA@XZ"(%"class.std::num_put"* %0) unnamed_addr #2 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Iput@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DPEAD_K@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i8* %5, i64 %6) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %8 = alloca i8*, align 8
...
95:                                               ; preds = %92
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %16) #12
  ...
  %99 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %17, i64 0) #12
...
109:                                              ; preds = %107
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %19) #12
...
111:                                              ; preds = %109
  %112 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAAEBD_K@Z"(%"class.std::basic_string"* %20, i64 0) #12
...
164:                                              ; preds = %92
  ...
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %16) #12 [ "funclet"(token %165) ]
  cleanupret from %165 unwind to caller

166:                                              ; preds = %107
  %167 = cleanuppad within none []
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %19) #12 [ "funclet"(token %167) ]
...
170:                                              ; preds = %169, %117, %111
  %171 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %17) #12
...
204:                                              ; preds = %199
  ...
  %208 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %17, i64 0) #12
...
217:                                              ; preds = %214
  ...
  %219 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %17, i64 0) #12
...
232:                                              ; preds = %214
  ...
  %234 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %17, i64 0) #12
...
241:                                              ; preds = %240, %211
  ...
  %246 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %17, i64 %245) #12
...
259:                                              ; preds = %254
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %20) #12
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %17) #12
  ret void

260:                                              ; preds = %254, %249, %241, %232, %222, %217, %204, %199, %189, %183, %176, %170, %146, %122
  %261 = cleanuppad within none []
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %20) #12 [ "funclet"(token %261) ]
  cleanupret from %261 unwind label %262

262:                                              ; preds = %260, %109, %166, %105, %95
  %263 = cleanuppad within none []
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %17) #12 [ "funclet"(token %263) ]
  cleanupret from %263 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32 @sprintf_s(i8* %0, i64 %1, i8* %2, ...) #0 comdat {
  %4 = alloca i8*, align 8
  %5 = alloca i64, align 8
  %6 = alloca i8*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(48) %"class.std::ctype"* @"??$use_facet@V?$ctype@D@std@@@std@@YAAEBV?$ctype@D@0@AEBVlocale@0@@Z"(%"class.std::locale"* nonnull align 8 dereferenceable(16) %0) #0 comdat personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.std::locale"*, align 8
  %3 = alloca %"class.std::_Lockit", align 4
  %4 = alloca %"class.std::locale::facet"*, align 8
  %5 = alloca i64, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@_KD@Z"(%"class.std::basic_string"* returned %0, i64 %1, i8 %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i8, align 1
  %5 = alloca i64, align 8
  ...
  %15 = call %"class.std::_Compressed_pair.1"* @"??$?0$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_Zero_then_variadic_args_t@1@@Z"(%"class.std::_Compressed_pair.1"* %12, i8 %14) #12
  ...
  %17 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %16, i32 0, i32 0
  ...
  %23 = invoke nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@_KD@Z"(%"class.std::basic_string"* %11, i64 %22, i8 %21)
...
25:                                               ; preds = %3
  %26 = cleanuppad within none []
  call void @"??1?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@XZ"(%"class.std::_Compressed_pair.1"* %12) #12 [ "funclet"(token %26) ]
  cleanupret from %26 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"?widen@?$ctype@D@std@@QEBAPEBDPEBD0PEAD@Z"(%"class.std::ctype"* %0, i8* %1, i8* %2, i8* %3) #0 comdat align 2 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %0, i64 %1) #2 comdat align 2 {
  %3 = alloca i64, align 8
  ...
  %7 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %6, i32 0, i32 0
  %8 = call i8* @"?_Myptr@?$_String_val@U?$_Simple_types@D@std@@@std@@QEAAPEADXZ"(%"class.std::_String_val"* %7) #12
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(48) %"class.std::numpunct"* @"??$use_facet@V?$numpunct@D@std@@@std@@YAAEBV?$numpunct@D@0@AEBVlocale@0@@Z"(%"class.std::locale"* nonnull align 8 dereferenceable(16) %0) #0 comdat personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.std::locale"*, align 8
  %3 = alloca %"class.std::_Lockit", align 4
  %4 = alloca %"class.std::locale::facet"*, align 8
  %5 = alloca i64, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?grouping@?$numpunct@D@std@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::numpunct"* %0, %"class.std::basic_string"* noalias sret align 8 %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAAEBD_K@Z"(%"class.std::basic_string"* %0, i64 %1) #2 comdat align 2 {
  %3 = alloca i64, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  store i64 %1, i64* %3, align 8
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %4, align 8
  ...
  %6 = getelementptr inbounds %"class.std::basic_string", %"class.std::basic_string"* %5, i32 0, i32 0
  %7 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %6, i32 0, i32 0
  %8 = call i8* @"?_Myptr@?$_String_val@U?$_Simple_types@D@std@@@std@@QEBAPEBDXZ"(%"class.std::_String_val"* %7) #12
  %9 = load i64, i64* %3, align 8
  %10 = getelementptr inbounds i8, i8* %8, i64 %9
  ret i8* %10
}
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8 @"?thousands_sep@?$numpunct@D@std@@QEBADXZ"(%"class.std::numpunct"* %0) #0 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@_K0D@Z"(%"class.std::basic_string"* %0, i64 %1, i64 %2, i8 %3) #0 comdat align 2 {
  ...
  %16 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %15, i32 0, i32 0
  %17 = load i64, i64* %8, align 8
  ...
  %19 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %18, i32 0, i32 0
  ...
  %24 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %23, i32 0, i32 0
...
30:                                               ; preds = %4
  ...
  %35 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %34, i32 0, i32 0
  ...
  %38 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %37, i32 0, i32 0
  %39 = call i8* @"?_Myptr@?$_String_val@U?$_Simple_types@D@std@@@std@@QEAAPEADXZ"(%"class.std::_String_val"* %38) #12
  ...
  %51 = call i8* @"?move@?$_Char_traits@DH@std@@SAPEADQEADQEBD_K@Z"(i8* %50, i8* %47, i64 %46) #12
  %52 = load i8, i8* %6, align 1
  %53 = load i64, i64* %7, align 8
  %54 = load i8*, i8** %12, align 8
  %55 = call i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %54, i64 %53, i8 %52) #12
...
56:                                               ; preds = %4
  ...
  %61 = getelementptr inbounds %class.anon.4, %class.anon.4* %13, i32 0, i32 0
...
define linkonce_odr dso_local i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %0) #2 comdat align 2 {
  ...
  %5 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %4, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Rep@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@D_K@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, i8 %3, i64 %4) #0 comdat align 2 {
  %6 = alloca i8*, align 8
  %7 = alloca i64, align 8
  %8 = alloca i8, align 1
...
15:                                               ; preds = %12
  ...
  %17 = call nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??D?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@XZ"(%"class.std::ostreambuf_iterator"* %2)
...
19:                                               ; preds = %15
  ...
  %22 = call nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??E?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@XZ"(%"class.std::ostreambuf_iterator"* %2)
  br label %12
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@PEBD_K@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, i8* %3, i64 %4) #0 comdat align 2 {
  %6 = alloca i8*, align 8
  %7 = alloca i64, align 8
  %8 = alloca i8*, align 8
  %9 = alloca %"class.std::num_put"*, align 8
...
15:                                               ; preds = %12
  ...
  %18 = call nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??D?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@XZ"(%"class.std::ostreambuf_iterator"* %2)
...
20:                                               ; preds = %15
  ...
  %23 = call nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??E?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@XZ"(%"class.std::ostreambuf_iterator"* %2)
...
define linkonce_odr dso_local void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %0) unnamed_addr #2 comdat align 2 {
  ...
  %4 = getelementptr inbounds %"class.std::basic_string", %"class.std::basic_string"* %3, i32 0, i32 0
  call void @"??1?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@XZ"(%"class.std::_Compressed_pair.1"* %4) #12
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i64 @"?_Getcat@?$ctype@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z"(%"class.std::locale::facet"** %0, %"class.std::locale"* %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.std::locale"*, align 8
  %4 = alloca %"class.std::locale::facet"**, align 8
  %5 = alloca %"class.std::_Locinfo", align 8
  %6 = alloca i1, align 1
...
13:                                               ; preds = %9
  %14 = call noalias nonnull i8* @"??2@YAPEAX_K@Z"(i64 48) #19
  store i1 true, i1* %6, align 1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::ctype"* @"??0?$ctype@D@std@@QEAA@AEBV_Locinfo@1@_K@Z"(%"class.std::ctype"* returned %0, %"class.std::_Locinfo"* nonnull align 8 dereferenceable(104) %1, i64 %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i64, align 8
  %5 = alloca %"class.std::_Locinfo"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Init@?$ctype@D@std@@IEAAXAEBV_Locinfo@2@@Z"(%"class.std::ctype"* %0, %"class.std::_Locinfo"* nonnull align 8 dereferenceable(104) %1) #0 comdat align 2 {
  %3 = alloca %"class.std::_Locinfo"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z"(%"class.std::ctype"* %0, i8* %1, i8* %2) unnamed_addr #0 comdat align 2 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %"class.std::ctype"*, align 8
  store i8* %2, i8** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8 @"?do_tolower@?$ctype@D@std@@MEBADD@Z"(%"class.std::ctype"* %0, i8 %1) unnamed_addr #0 comdat align 2 {
  %3 = alloca i8, align 1
  %4 = alloca %"class.std::ctype"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z"(%"class.std::ctype"* %0, i8* %1, i8* %2) unnamed_addr #0 comdat align 2 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %"class.std::ctype"*, align 8
  store i8* %2, i8** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8 @"?do_toupper@?$ctype@D@std@@MEBADD@Z"(%"class.std::ctype"* %0, i8 %1) unnamed_addr #0 comdat align 2 {
  %3 = alloca i8, align 1
  %4 = alloca %"class.std::ctype"*, align 8
  store i8 %1, i8* %3, align 1
  store %"class.std::ctype"* %0, %"class.std::ctype"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"?do_widen@?$ctype@D@std@@MEBAPEBDPEBD0PEAD@Z"(%"class.std::ctype"* %0, i8* %1, i8* %2, i8* %3) unnamed_addr #0 comdat align 2 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i8*, align 8
  %8 = alloca %"class.std::ctype"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Getctype@_Locinfo@std@@QEBA?AU_Ctypevec@@XZ"(%"class.std::_Locinfo"* %0, %struct._Ctypevec* noalias sret align 8 %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::_Locinfo"*, align 8
...
declare dso_local void @_Getctype(%struct._Ctypevec* sret align 8) #5
...
; Function Attrs: nobuiltin nounwind
declare dso_local void @"??_V@YAXPEAX@Z"(i8*) #7
...
declare dso_local i32 @_Tolower(i32, %struct._Ctypevec*) #5

declare dso_local i32 @_Toupper(i32, %struct._Ctypevec*) #5
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.std::_Compressed_pair.1"* @"??$?0$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_Zero_then_variadic_args_t@1@@Z"(%"class.std::_Compressed_pair.1"* returned %0, i8 %1) unnamed_addr #2 comdat align 2 {
  %3 = alloca %"struct.std::_Zero_then_variadic_args_t", align 1
  %4 = alloca %"class.std::_Compressed_pair.1"*, align 8
  %5 = getelementptr inbounds %"struct.std::_Zero_then_variadic_args_t", %"struct.std::_Zero_then_variadic_args_t"* %3, i32 0, i32 0
  store i8 %1, i8* %5, align 1
  store %"class.std::_Compressed_pair.1"* %0, %"class.std::_Compressed_pair.1"** %4, align 8
  %6 = load %"class.std::_Compressed_pair.1"*, %"class.std::_Compressed_pair.1"** %4, align 8
  %7 = bitcast %"class.std::_Compressed_pair.1"* %6 to %"class.std::allocator"*
  %8 = call %"class.std::allocator"* @"??0?$allocator@D@std@@QEAA@XZ"(%"class.std::allocator"* %7) #12
  %9 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %6, i32 0, i32 0
  %10 = call %"class.std::_String_val"* @"??0?$_String_val@U?$_Simple_types@D@std@@@std@@QEAA@XZ"(%"class.std::_String_val"* %9) #12
  ret %"class.std::_Compressed_pair.1"* %6
}
...
define linkonce_odr dso_local void @"?_Tidy_init@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXXZ"(%"class.std::basic_string"* %0) #2 comdat align 2 {
  ...
  %6 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %5, i32 0, i32 0
  ...
  %9 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %8, i32 0, i32 0
  ...
  %12 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %11, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@_KD@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2) #0 comdat align 2 {
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca i8, align 1
  %6 = alloca i64, align 8
  ...
  %14 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %13, i32 0, i32 0
...
18:                                               ; preds = %3
  ...
  %20 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %19, i32 0, i32 0
  ...
  %29 = call i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %28, i64 %27, i8 %26) #12
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??1?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@XZ"(%"class.std::_Compressed_pair.1"* %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %"class.std::_Compressed_pair.1"*, align 8
  store %"class.std::_Compressed_pair.1"* %0, %"class.std::_Compressed_pair.1"** %2, align 8
  %3 = load %"class.std::_Compressed_pair.1"*, %"class.std::_Compressed_pair.1"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %0, i64 %1, i8 %2) #2 comdat align 2 {
  %4 = alloca i8, align 1
  %5 = alloca i64, align 8
  %6 = alloca i8*, align 8
  store i8 %2, i8* %4, align 1
...
19:                                               ; preds = %4
  ...
  %21 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %20, i32 0, i32 0
  ...
  %32 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %31, i32 0, i32 0
  ...
  %36 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %35, i32 0, i32 0
  ...
  %40 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %39, i32 0, i32 0
  ...
  call void @"??R<lambda_1>@?0??assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_KD@Z@QEBA?A?<auto>@@QEAD0D@Z"(%class.anon* %5, i8* %45, i64 %43, i8 %42)
...
48:                                               ; preds = %19
  ...
  %53 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %52, i32 0, i32 0
  ...
  %59 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %58, i32 0, i32 0
...
62:                                               ; preds = %19
  ...
  %64 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %63, i32 0, i32 0
...
; Function Attrs: noinline noreturn optnone uwtable
define linkonce_odr dso_local void @"?_Xlen_string@std@@YAXXZ"() #4 comdat {
  call void @"?_Xlength_error@std@@YAXPEBD@Z"(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @"??_C@_0BA@JFNIOLAK@string?5too?5long?$AA@", i64 0, i64 0)) #17
  unreachable
}
...
define linkonce_odr dso_local i64 @"?_Calculate_growth@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBA_K_K@Z"(%"class.std::basic_string"* %0, i64 %1) #2 comdat align 2 {
  ...
  %8 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %7, i32 0, i32 0
...
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Getal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV?$allocator@D@2@XZ"(%"class.std::basic_string"* %0) #2 comdat align 2 {
  ...
  %3 = load %"class.std::basic_string"*, %"class.std::basic_string"** %2, align 8
  %4 = getelementptr inbounds %"class.std::basic_string", %"class.std::basic_string"* %3, i32 0, i32 0
  %5 = call nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Get_first@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAAAEAV?$allocator@D@2@XZ"(%"class.std::_Compressed_pair.1"* %4) #12
  ret %"class.std::allocator"* %5
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"?allocate@?$allocator@D@std@@QEAAPEAD_K@Z"(%"class.std::allocator"* %0, i64 %1) #0 comdat align 2 {
  %3 = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??R<lambda_1>@?0??assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_KD@Z@QEBA?A?<auto>@@QEAD0D@Z"(%class.anon* %0, i8* %1, i64 %2, i8 %3) #2 comdat align 2 {
  %5 = alloca i8, align 1
  %6 = alloca i64, align 8
  %7 = alloca i8*, align 8
  ...
  %12 = load i64, i64* %6, align 8
  %13 = load i8*, i8** %7, align 8
  %14 = call i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %13, i64 %12, i8 %11) #12
  store i8 0, i8* %9, align 1
...
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Getal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBAAEBV?$allocator@D@2@XZ"(%"class.std::basic_string"* %0) #2 comdat align 2 {
  ...
  %3 = load %"class.std::basic_string"*, %"class.std::basic_string"** %2, align 8
  %4 = getelementptr inbounds %"class.std::basic_string", %"class.std::basic_string"* %3, i32 0, i32 0
  %5 = call nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Get_first@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEBAAEBV?$allocator@D@2@XZ"(%"class.std::_Compressed_pair.1"* %4) #12
  ret %"class.std::allocator"* %5
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Get_first@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEBAAEBV?$allocator@D@2@XZ"(%"class.std::_Compressed_pair.1"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::_Compressed_pair.1"*, align 8
  store %"class.std::_Compressed_pair.1"* %0, %"class.std::_Compressed_pair.1"** %2, align 8
  %3 = load %"class.std::_Compressed_pair.1"*, %"class.std::_Compressed_pair.1"** %2, align 8
  %4 = bitcast %"class.std::_Compressed_pair.1"* %3 to %"class.std::allocator"*
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Get_first@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAAAEAV?$allocator@D@2@XZ"(%"class.std::_Compressed_pair.1"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::_Compressed_pair.1"*, align 8
  store %"class.std::_Compressed_pair.1"* %0, %"class.std::_Compressed_pair.1"** %2, align 8
  %3 = load %"class.std::_Compressed_pair.1"*, %"class.std::_Compressed_pair.1"** %2, align 8
  %4 = bitcast %"class.std::_Compressed_pair.1"* %3 to %"class.std::allocator"*
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"??$_Allocate@$0BA@U_Default_allocate_traits@std@@$0A@@std@@YAPEAX_K@Z"(i64 %0) #0 comdat {
  %2 = alloca i8*, align 8
  %3 = alloca i64, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"??$_Allocate_manually_vector_aligned@U_Default_allocate_traits@std@@@std@@YAPEAX_K@Z"(i64 %0) #0 comdat {
  %2 = alloca i64, align 8
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca i8*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"?_Allocate@_Default_allocate_traits@std@@SAPEAX_K@Z"(i64 %0) #0 comdat align 2 {
  %2 = alloca i64, align 8
  store i64 %0, i64* %2, align 8
  %3 = load i64, i64* %2, align 8
  %4 = call noalias nonnull i8* @"??2@YAPEAX_K@Z"(i64 %3) #22
  ret i8* %4
}

; Function Attrs: noinline noreturn optnone uwtable
define linkonce_odr dso_local void @"?_Throw_bad_array_new_length@std@@YAXXZ"() #4 comdat {
  ...
  call void @_CxxThrowException(i8* %3, %eh.ThrowInfo* @"_TI3?AVbad_array_new_length@std@@") #17
  unreachable
}
...
declare dso_local void @__std_exception_destroy(%struct.__std_exception_data*) #5
...
declare dso_local void @__std_exception_copy(%struct.__std_exception_data*, %struct.__std_exception_data*) #5
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Adjust_manually_vector_aligned@std@@YAXAEAPEAXAEA_K@Z"(i8** nonnull align 8 dereferenceable(8) %0, i64* nonnull align 8 dereferenceable(8) %1) #0 comdat {
  %3 = alloca i64*, align 8
  %4 = alloca i8**, align 8
  %5 = alloca i64*, align 8
  %6 = alloca i64, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i64 @"?_Getcat@?$numpunct@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z"(%"class.std::locale::facet"** %0, %"class.std::locale"* %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.std::locale"*, align 8
  %4 = alloca %"class.std::locale::facet"**, align 8
  %5 = alloca %"class.std::_Locinfo", align 8
  %6 = alloca i1, align 1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::numpunct"* @"??0?$numpunct@D@std@@QEAA@AEBV_Locinfo@1@_K_N@Z"(%"class.std::numpunct"* returned %0, %"class.std::_Locinfo"* nonnull align 8 dereferenceable(104) %1, i64 %2, i1 zeroext %3) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %5 = alloca i8, align 1
  %6 = alloca i64, align 8
...
19:                                               ; preds = %4
  ...
  call void @"??1facet@locale@std@@MEAA@XZ"(%"class.std::locale::facet"* %21) #12 [ "funclet"(token %20) ]
  cleanupret from %20 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Init@?$numpunct@D@std@@IEAAXAEBV_Locinfo@2@_N@Z"(%"class.std::numpunct"* %0, %"class.std::_Locinfo"* nonnull align 8 dereferenceable(104) %1, i1 zeroext %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i8, align 1
  %5 = alloca %"class.std::_Locinfo"*, align 8
...
62:                                               ; preds = %61, %55
  call void @"??1?$_Tidy_guard@V?$numpunct@D@std@@@std@@QEAA@XZ"(%"struct.std::_Tidy_guard"* %9) #12
  ret void

63:                                               ; preds = %57, %52, %50, %43, %39, %37, %33, %30, %3
  %64 = cleanuppad within none []
  call void @"??1?$_Tidy_guard@V?$numpunct@D@std@@@std@@QEAA@XZ"(%"struct.std::_Tidy_guard"* %9) #12 [ "funclet"(token %64) ]
  cleanupret from %64 unwind to caller
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"??_G?$numpunct@D@std@@MEAAPEAXI@Z"(%"class.std::numpunct"* %0, i32 %1) unnamed_addr #2 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  ...
  store i8* %7, i8** %3, align 8
  %8 = load i32, i32* %4, align 4
  call void @"??1?$numpunct@D@std@@MEAA@XZ"(%"class.std::numpunct"* %6) #12
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %12, label %10
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8 @"?do_decimal_point@?$numpunct@D@std@@MEBADXZ"(%"class.std::numpunct"* %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %"class.std::numpunct"*, align 8
  store %"class.std::numpunct"* %0, %"class.std::numpunct"** %2, align 8
  %3 = load %"class.std::numpunct"*, %"class.std::numpunct"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8 @"?do_thousands_sep@?$numpunct@D@std@@MEBADXZ"(%"class.std::numpunct"* %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %"class.std::numpunct"*, align 8
  store %"class.std::numpunct"* %0, %"class.std::numpunct"** %2, align 8
  %3 = load %"class.std::numpunct"*, %"class.std::numpunct"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_grouping@?$numpunct@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::numpunct"* %0, %"class.std::basic_string"* noalias sret align 8 %1) unnamed_addr #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::numpunct"*, align 8
  %5 = bitcast %"class.std::basic_string"* %1 to i8*
  store i8* %5, i8** %3, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_falsename@?$numpunct@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::numpunct"* %0, %"class.std::basic_string"* noalias sret align 8 %1) unnamed_addr #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::numpunct"*, align 8
  %5 = bitcast %"class.std::basic_string"* %1 to i8*
  store i8* %5, i8** %3, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?do_truename@?$numpunct@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::numpunct"* %0, %"class.std::basic_string"* noalias sret align 8 %1) unnamed_addr #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::numpunct"*, align 8
  %5 = bitcast %"class.std::basic_string"* %1 to i8*
  store i8* %5, i8** %3, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %struct.lconv* @"?_Getlconv@_Locinfo@std@@QEBAPEBUlconv@@XZ"(%"class.std::_Locinfo"* %0) #0 comdat align 2 {
  %2 = alloca %"class.std::_Locinfo"*, align 8
  store %"class.std::_Locinfo"* %0, %"class.std::_Locinfo"** %2, align 8
  %3 = load %"class.std::_Locinfo"*, %"class.std::_Locinfo"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Getcvt@_Locinfo@std@@QEBA?AU_Cvtvec@@XZ"(%"class.std::_Locinfo"* %0, %struct._Cvtvec* noalias sret align 4 %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::_Locinfo"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8* @"??$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z"(i8* %0, i8* %1, %struct._Cvtvec* nonnull align 4 dereferenceable(44) %2) #0 comdat {
...
17:                                               ; preds = %3
  call void @"?_Xbad_alloc@std@@YAXXZ"() #17
  unreachable
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"?_Getfalse@_Locinfo@std@@QEBAPEBDXZ"(%"class.std::_Locinfo"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::_Locinfo"*, align 8
  store %"class.std::_Locinfo"* %0, %"class.std::_Locinfo"** %2, align 8
  %3 = load %"class.std::_Locinfo"*, %"class.std::_Locinfo"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"?_Gettrue@_Locinfo@std@@QEBAPEBDXZ"(%"class.std::_Locinfo"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::_Locinfo"*, align 8
  store %"class.std::_Locinfo"* %0, %"class.std::_Locinfo"** %2, align 8
  %3 = load %"class.std::_Locinfo"*, %"class.std::_Locinfo"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8 @"??$_Maklocchr@D@std@@YADDPEADAEBU_Cvtvec@@@Z"(i8 %0, i8* %1, %struct._Cvtvec* nonnull align 4 dereferenceable(44) %2) #2 comdat {
  %4 = alloca %struct._Cvtvec*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8, align 1
  store %struct._Cvtvec* %2, %struct._Cvtvec** %4, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??$_Getvals@D@?$numpunct@D@std@@IEAAXDPEBUlconv@@U_Cvtvec@@@Z"(%"class.std::numpunct"* %0, i8 %1, %struct.lconv* %2, %struct._Cvtvec* %3) #2 comdat align 2 {
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??1?$_Tidy_guard@V?$numpunct@D@std@@@std@@QEAA@XZ"(%"struct.std::_Tidy_guard"* %0) unnamed_addr #2 comdat align 2 {
...
7:                                                ; preds = %1
  ...
  call void @"?_Tidy@?$numpunct@D@std@@AEAAXXZ"(%"class.std::numpunct"* %9) #12
  br label %10
...
declare dso_local void @_Getcvt(%struct._Cvtvec* sret align 4) #5
...
; Function Attrs: noreturn
declare dso_local void @"?_Xbad_alloc@std@@YAXXZ"() #8

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"?_Tidy@?$numpunct@D@std@@AEAAXXZ"(%"class.std::numpunct"* %0) #2 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.std::numpunct"*, align 8
  store %"class.std::numpunct"* %0, %"class.std::numpunct"** %2, align 8
  %3 = load %"class.std::numpunct"*, %"class.std::numpunct"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??1?$numpunct@D@std@@MEAA@XZ"(%"class.std::numpunct"* %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %"class.std::numpunct"*, align 8
  store %"class.std::numpunct"* %0, %"class.std::numpunct"** %2, align 8
  %3 = load %"class.std::numpunct"*, %"class.std::numpunct"** %2, align 8
  %4 = bitcast %"class.std::numpunct"* %3 to i32 (...)***
  store i32 (...)** bitcast (i8** @"??_7?$numpunct@D@std@@6B@" to i32 (...)**), i32 (...)*** %4, align 8
  call void @"?_Tidy@?$numpunct@D@std@@AEAAXXZ"(%"class.std::numpunct"* %3) #12
  %5 = bitcast %"class.std::numpunct"* %3 to %"class.std::locale::facet"*
  call void @"??1facet@locale@std@@MEAA@XZ"(%"class.std::locale::facet"* %5) #12
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@QEBD@Z"(%"class.std::basic_string"* returned %0, i8* %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca %"struct.std::_Zero_then_variadic_args_t", align 1
  ...
  %13 = call %"class.std::_Compressed_pair.1"* @"??$?0$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_Zero_then_variadic_args_t@1@@Z"(%"class.std::_Compressed_pair.1"* %10, i8 %12) #12
  ...
  %15 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %14, i32 0, i32 0
...
22:                                               ; preds = %2
  ...
  call void @"??1?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@XZ"(%"class.std::_Compressed_pair.1"* %10) #12 [ "funclet"(token %23) ]
  cleanupret from %23 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@QEBD@Z"(%"class.std::basic_string"* %0, i8* %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  store i8* %1, i8** %3, align 8
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@QEBD_K@Z"(%"class.std::basic_string"* %0, i8* %1, i64 %2) #0 comdat align 2 {
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca i64, align 8
  %6 = alloca i8*, align 8
  %7 = alloca %"class.std::basic_string"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??$_Reallocate_for@V<lambda_1>@?0??assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV34@QEBD_K@Z@PEBD@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV<lambda_1>@?0??assign@01@QEAAAEAV01@QEBD0@Z@PEBD@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2, i8* %3) #0 comdat align 2 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Check_offset@?$_String_val@U?$_Simple_types@D@std@@@std@@QEBAX_K@Z"(%"class.std::_String_val"* %0, i64 %1) #0 comdat align 2 {
  %3 = alloca i64, align 8
...
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??$_Reallocate_grow_by@V<lambda_1>@?0??insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV34@_K0D@Z@_K_KD@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV<lambda_1>@?0??insert@01@QEAAAEAV01@00D@Z@_K2D@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2, i64 %3, i64 %4, i8 %5) #0 comdat align 2 {
  ...
  %21 = alloca i8*, align 8
  %22 = getelementptr inbounds %class.anon.4, %class.anon.4* %7, i32 0, i32 0
  ...
  %25 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %24, i32 0, i32 0
  ...
  %29 = call i64 @"?max_size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %23) #12
...
35:                                               ; preds = %6
  ...
  %43 = call i64 @"?_Calculate_growth@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBA_K_K@Z"(%"class.std::basic_string"* %23, i64 %42) #12
  store i64 %43, i64* %17, align 8
  %44 = call nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Getal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV?$allocator@D@2@XZ"(%"class.std::basic_string"* %23) #12
  ...
  call void @"?_Orphan_all@_Container_base0@std@@QEAAXXZ"(%"struct.std::_Container_base0"* %50) #12
  ...
  %58 = call i8* @"??$_Unfancy@D@std@@YAPEADPEAD@Z"(i8* %57) #12
...
61:                                               ; preds = %35
  ...
  %71 = call i8* @"??$_Unfancy@D@std@@YAPEADPEAD@Z"(i8* %70) #12
  %72 = load i8*, i8** %20, align 8
  call void @"??R<lambda_1>@?0??insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_K0D@Z@QEBA?A?<auto>@@QEADQEBD000D@Z"(%class.anon.4* %7, i8* %72, i8* %71, i64 %69, i64 %68, i64 %67, i8 %66)
...
81:                                               ; preds = %35
  ...
  call void @"??R<lambda_1>@?0??insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_K0D@Z@QEBA?A?<auto>@@QEADQEBD000D@Z"(%class.anon.4* %7, i8* %90, i8* %89, i64 %85, i64 %84, i64 %83, i8 %82)
  ...
  call void @"??$_Construct_in_place@PEADAEBQEAD@std@@YAXAEAPEADAEBQEAD@Z"(i8** nonnull align 8 dereferenceable(8) %93, i8** nonnull align 8 dereferenceable(8) %19) #12
  br label %94
...
; Function Attrs: noinline noreturn optnone uwtable
define linkonce_odr dso_local void @"?_Xran@?$_String_val@U?$_Simple_types@D@std@@@std@@SAXXZ"() #4 comdat align 2 {
  call void @"?_Xout_of_range@std@@YAXPEBD@Z"(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @"??_C@_0BI@CFPLBAOH@invalid?5string?5position?$AA@", i64 0, i64 0)) #17
  unreachable
}
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??R<lambda_1>@?0??insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_K0D@Z@QEBA?A?<auto>@@QEADQEBD000D@Z"(%class.anon.4* %0, i8* %1, i8* %2, i64 %3, i64 %4, i64 %5, i8 %6) #2 comdat align 2 {
  %8 = alloca i8, align 1
  %9 = alloca i64, align 8
  %10 = alloca i64, align 8
  %11 = alloca i64, align 8
  ...
  store %class.anon.4* %0, %class.anon.4** %14, align 8
  %15 = load %class.anon.4*, %class.anon.4** %14, align 8
  %16 = load i64, i64* %10, align 8
  %17 = load i8*, i8** %12, align 8
  %18 = load i8*, i8** %13, align 8
  %19 = call i8* @"?copy@?$_Char_traits@DH@std@@SAPEADQEADQEBD_K@Z"(i8* %18, i8* %17, i64 %16) #12
  %20 = load i8, i8* %8, align 1
  %21 = load i64, i64* %9, align 8
  %22 = load i8*, i8** %13, align 8
  %23 = load i64, i64* %10, align 8
  %24 = getelementptr inbounds i8, i8* %22, i64 %23
  %25 = call i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %24, i64 %21, i8 %20) #12
  ...
  %38 = call i8* @"?copy@?$_Char_traits@DH@std@@SAPEADQEADQEBD_K@Z"(i8* %37, i8* %32, i64 %29) #12
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??D?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@XZ"(%"class.std::ostreambuf_iterator"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::ostreambuf_iterator"*, align 8
  store %"class.std::ostreambuf_iterator"* %0, %"class.std::ostreambuf_iterator"** %2, align 8
  %3 = load %"class.std::ostreambuf_iterator"*, %"class.std::ostreambuf_iterator"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??4?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@D@Z"(%"class.std::ostreambuf_iterator"* %0, i8 %1) #0 comdat align 2 {
  %3 = alloca i8, align 1
  %4 = alloca %"class.std::ostreambuf_iterator"*, align 8
  %5 = alloca i32, align 4
...
11:                                               ; preds = %2
  ...
  %16 = call i32 @"?eof@?$_Narrow_char_traits@DH@std@@SAHXZ"() #12
  store i32 %16, i32* %6, align 4
  %17 = call zeroext i1 @"?eq_int_type@?$_Narrow_char_traits@DH@std@@SA_NAEBH0@Z"(i32* nonnull align 4 dereferenceable(4) %6, i32* nonnull align 4 dereferenceable(4) %5) #12
  br label %18
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(16) %"class.std::ostreambuf_iterator"* @"??E?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@QEAAAEAV01@XZ"(%"class.std::ostreambuf_iterator"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::ostreambuf_iterator"*, align 8
  store %"class.std::ostreambuf_iterator"* %0, %"class.std::ostreambuf_iterator"** %2, align 8
  %3 = load %"class.std::ostreambuf_iterator"*, %"class.std::ostreambuf_iterator"** %2, align 8
  ret %"class.std::ostreambuf_iterator"* %3
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32 @"?sputc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QEAAHD@Z"(%"class.std::basic_streambuf"* %0, i8 %1) #0 comdat align 2 {
  %3 = alloca i8, align 1
...
define linkonce_odr dso_local void @"?_Tidy_deallocate@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXXZ"(%"class.std::basic_string"* %0) #2 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  ...
  %11 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %10, i32 0, i32 0
...
13:                                               ; preds = %1
  ...
  %26 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %25, i32 0, i32 0
...
32:                                               ; preds = %31, %1
  ...
  %34 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %33, i32 0, i32 0
  ...
  %37 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %36, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i32 @_vsprintf_s_l(i8* %0, i64 %1, i8* %2, %struct.__crt_locale_pointers* %3, i8* %4) #0 comdat {
  %6 = alloca i8*, align 8
...
declare dso_local i32 @__stdio_common_vsprintf_s(i64, i8*, i64, i8*, %struct.__crt_locale_pointers*, i8*) #5
...
define linkonce_odr dso_local %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* returned %0) unnamed_addr #2 comdat align 2 {
  ...
  %9 = call %"class.std::_Compressed_pair.1"* @"??$?0$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_Zero_then_variadic_args_t@1@@Z"(%"class.std::_Compressed_pair.1"* %6, i8 %8) #12
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i64 @"?precision@ios_base@std@@QEBA_JXZ"(%"class.std::ios_base"* %0) #2 comdat align 2 {
  %2 = alloca %"class.std::ios_base"*, align 8
  store %"class.std::ios_base"* %0, %"class.std::ios_base"** %2, align 8
  %3 = load %"class.std::ios_base"*, %"class.std::ios_base"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @"??$_Float_put_desired_precision@O@std@@YAH_JH@Z"(i64 %0, i32 %1) #2 comdat {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i64, align 8
  %6 = alloca i8, align 1
...
define linkonce_odr dso_local double @fabsl(double %0) #13 comdat {
...
define linkonce_odr dso_local double @frexpl(double %0, i32* %1) #14 comdat {
  %3 = alloca i32*, align 8
  ...
  %7 = call double @frexp(double %6, i32* %5) #12
  ret double %7
}

; Function Attrs: nounwind readnone
declare dso_local i32 @abs(i32) #15

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?resize@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAX_KD@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2) #0 comdat align 2 {
  %4 = alloca i8, align 1
  %5 = alloca i64, align 8
  %6 = alloca %"class.std::basic_string"*, align 8
  %7 = alloca i64, align 8
  ...
  %9 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %8) #12
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"?_Ffmt@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBAPEADPEADDH@Z"(%"class.std::num_put"* %0, i8* %1, i8 %2, i32 %3) #2 comdat align 2 {
  %5 = alloca i32, align 4
  %6 = alloca i8, align 1
  %7 = alloca i8*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Fput@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DPEBD_K@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i8* %5, i64 %6) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %8 = alloca i8*, align 8
  %9 = alloca i64, align 8
  %10 = alloca i8*, align 8
  %11 = alloca i8, align 1
...
117:                                              ; preds = %99
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %20) #12
  ...
  %121 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %21, i64 0) #12
...
131:                                              ; preds = %129
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %23) #12
...
143:                                              ; preds = %140
  ...
  %145 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %21, i64 %144) #12
  store i8 %142, i8* %145, align 1
  br label %150

146:                                              ; preds = %99
  %147 = cleanuppad within none []
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %20) #12 [ "funclet"(token %147) ]
  cleanupret from %147 unwind to caller

148:                                              ; preds = %129
  %149 = cleanuppad within none []
  call void @"??1locale@std@@QEAA@XZ"(%"class.std::locale"* %23) #12 [ "funclet"(token %149) ]
...
158:                                              ; preds = %156, %154
  ...
  %160 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBAAEBD_K@Z"(%"class.std::basic_string"* %24, i64 0) #12
...
199:                                              ; preds = %179
  %200 = call i64 @"?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEBA_KXZ"(%"class.std::basic_string"* %21) #12
...
233:                                              ; preds = %228
  ...
  %237 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %21, i64 0) #12
...
246:                                              ; preds = %243
  ...
  %248 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %21, i64 0) #12
...
261:                                              ; preds = %243
  ...
  %263 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %21, i64 0) #12
...
270:                                              ; preds = %269, %240
  ...
  %275 = call nonnull align 1 dereferenceable(1) i8* @"??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAD_K@Z"(%"class.std::basic_string"* %21, i64 %274) #12
...
288:                                              ; preds = %283
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %24) #12
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %21) #12
  ret void

289:                                              ; preds = %283, %278, %270, %261, %251, %246, %233, %228, %218, %212, %205, %199, %181, %140, %133
  %290 = cleanuppad within none []
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %24) #12 [ "funclet"(token %290) ]
  cleanupret from %290 unwind label %291

291:                                              ; preds = %289, %131, %148, %127, %117
  %292 = cleanuppad within none []
  call void @"??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@XZ"(%"class.std::basic_string"* %21) #12 [ "funclet"(token %292) ]
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAX_K@Z"(%"class.std::basic_string"* %0, i64 %1) #2 comdat align 2 {
  %3 = alloca i64, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca i8, align 1
  store i64 %1, i64* %3, align 8
  ...
  %7 = getelementptr inbounds %"class.std::basic_string", %"class.std::basic_string"* %6, i32 0, i32 0
  %8 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %7, i32 0, i32 0
  %9 = call i8* @"?_Myptr@?$_String_val@U?$_Simple_types@D@std@@@std@@QEAAPEADXZ"(%"class.std::_String_val"* %8) #12
  %10 = load i64, i64* %3, align 8
  ...
  call void @"?assign@?$_Narrow_char_traits@DH@std@@SAXAEADAEBD@Z"(i8* nonnull align 1 dereferenceable(1) %14, i8* nonnull align 1 dereferenceable(1) %5) #12
  ret void
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@_KD@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2) #0 comdat align 2 {
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca i8, align 1
  %6 = alloca i64, align 8
  %7 = alloca %"class.std::basic_string"*, align 8
...
25:                                               ; preds = %3
  ...
  %30 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %29, i32 0, i32 0
  ...
  %33 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %32, i32 0, i32 0
  ...
  %40 = call i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %39, i64 %36, i8 %35) #12
...
46:                                               ; preds = %3
  ...
  %50 = getelementptr inbounds %class.anon.6, %class.anon.6* %11, i32 0, i32 0
...
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??$_Reallocate_grow_by@V<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV34@_KD@Z@_KD@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV<lambda_1>@?0??append@01@QEAAAEAV01@0D@Z@_KD@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2, i64 %3, i8 %4) #0 comdat align 2 {
  ...
  %19 = alloca i8*, align 8
  %20 = getelementptr inbounds %class.anon.6, %class.anon.6* %6, i32 0, i32 0
  ...
  %23 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %22, i32 0, i32 0
...
59:                                               ; preds = %33
  ...
  call void @"??R<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_KD@Z@QEBA?A?<auto>@@QEADQEBD00D@Z"(%class.anon.6* %6, i8* %69, i8* %68, i64 %66, i64 %65, i8 %64)
...
78:                                               ; preds = %33
  ...
  call void @"??R<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_KD@Z@QEBA?A?<auto>@@QEADQEBD00D@Z"(%class.anon.6* %6, i8* %86, i8* %85, i64 %81, i64 %80, i8 %79)
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??R<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@_KD@Z@QEBA?A?<auto>@@QEADQEBD00D@Z"(%class.anon.6* %0, i8* %1, i8* %2, i64 %3, i64 %4, i8 %5) #2 comdat align 2 {
  %7 = alloca i8, align 1
  %8 = alloca i64, align 8
  %9 = alloca i64, align 8
  %10 = alloca i8*, align 8
  ...
  store %class.anon.6* %0, %class.anon.6** %12, align 8
  %14 = load %class.anon.6*, %class.anon.6** %12, align 8
  %15 = load i64, i64* %9, align 8
  %16 = load i8*, i8** %10, align 8
  ...
  %24 = call i8* @"?assign@?$_Narrow_char_traits@DH@std@@SAPEADQEAD_KD@Z"(i8* %23, i64 %20, i8 %19) #12
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8 @"?decimal_point@?$numpunct@D@std@@QEBADXZ"(%"class.std::numpunct"* %0) #0 comdat align 2 {
  %2 = alloca %"class.std::numpunct"*, align 8
  store %"class.std::numpunct"* %0, %"class.std::numpunct"** %2, align 8
  %3 = load %"class.std::numpunct"*, %"class.std::numpunct"** %2, align 8
  %4 = bitcast %"class.std::numpunct"* %3 to i8 (%"class.std::numpunct"*)***
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i32 @"??$_Float_put_desired_precision@N@std@@YAH_JH@Z"(i64 %0, i32 %1) #2 comdat {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i64, align 8
  %6 = alloca i8, align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local i8* @"?_Ifmt@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBAPEADPEADPEBDH@Z"(%"class.std::num_put"* %0, i8* %1, i8* %2, i32 %3) #2 comdat align 2 {
  %5 = alloca i32, align 4
  %6 = alloca i8*, align 8
  %7 = alloca i8*, align 8
  %8 = alloca %"class.std::num_put"*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@$$QEAV12@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1) #2 comdat align 2 {
  ...
  %7 = call nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??$move@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AEAV10@@Z"(%"class.std::basic_string"* nonnull align 8 dereferenceable(32) %6) #12
  %8 = call nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV01@$$QEAV01@@Z"(%"class.std::basic_string"* %5, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %7) #12
  ret %"class.std::basic_string"* %5
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?truename@?$numpunct@D@std@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::numpunct"* %0, %"class.std::basic_string"* noalias sret align 8 %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::numpunct"*, align 8
  %5 = bitcast %"class.std::basic_string"* %1 to i8*
  store i8* %5, i8** %3, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?falsename@?$numpunct@D@std@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::numpunct"* %0, %"class.std::basic_string"* noalias sret align 8 %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::numpunct"*, align 8
  %5 = bitcast %"class.std::basic_string"* %1 to i8*
  store i8* %5, i8** %3, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??$move@AEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YA$$QEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AEAV10@@Z"(%"class.std::basic_string"* nonnull align 8 dereferenceable(32) %0) #2 comdat {
  %2 = alloca %"class.std::basic_string"*, align 8
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %2, align 8
  %3 = load %"class.std::basic_string"*, %"class.std::basic_string"** %2, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV01@$$QEAV01@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1) #2 comdat align 2 {
  %3 = alloca %"class.std::basic_string"*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  ...
  %8 = call %"class.std::basic_string"* @"??$addressof@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YAPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AEAV10@@Z"(%"class.std::basic_string"* nonnull align 8 dereferenceable(32) %7) #12
...
10:                                               ; preds = %2
  ...
  %13 = load i8, i8* %12, align 1
  call void @"?_Move_assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXAEAV12@U_Equal_allocators@2@@Z"(%"class.std::basic_string"* %6, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %11, i8 %13) #12
  br label %14
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.std::basic_string"* @"??$addressof@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@YAPEAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@AEAV10@@Z"(%"class.std::basic_string"* nonnull align 8 dereferenceable(32) %0) #2 comdat {
  %2 = alloca %"class.std::basic_string"*, align 8
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %2, align 8
  %3 = load %"class.std::basic_string"*, %"class.std::basic_string"** %2, align 8
  ret %"class.std::basic_string"* %3
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"?_Move_assign@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXAEAV12@U_Equal_allocators@2@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1, i8 %2) #2 comdat align 2 {
  ...
  call void @"?_Tidy_deallocate@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXXZ"(%"class.std::basic_string"* %9) #12
  ...
  %12 = call nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"?_Getal@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV?$allocator@D@2@XZ"(%"class.std::basic_string"* %9) #12
  call void @"??$_Pocma@V?$allocator@D@std@@@std@@YAXAEAV?$allocator@D@0@0@Z"(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %12, %"class.std::allocator"* nonnull align 1 dereferenceable(1) %11) #12
  %13 = load %"class.std::basic_string"*, %"class.std::basic_string"** %5, align 8
  %14 = getelementptr inbounds %"struct.std::integral_constant", %"struct.std::integral_constant"* %7, i32 0, i32 0
  %15 = load i8, i8* %14, align 1
  call void @"?_Take_contents@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXAEAV12@U?$integral_constant@_N$00@2@@Z"(%"class.std::basic_string"* %9, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %13, i8 %15) #12
  ret void
}

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??$_Pocma@V?$allocator@D@std@@@std@@YAXAEAV?$allocator@D@0@0@Z"(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %0, %"class.std::allocator"* nonnull align 1 dereferenceable(1) %1) #2 comdat {
  %3 = alloca %"class.std::allocator"*, align 8
  %4 = alloca %"class.std::allocator"*, align 8
  store %"class.std::allocator"* %1, %"class.std::allocator"** %3, align 8
  store %"class.std::allocator"* %0, %"class.std::allocator"** %4, align 8
  %5 = load %"class.std::allocator"*, %"class.std::allocator"** %3, align 8
  %6 = call nonnull align 1 dereferenceable(1) %"class.std::allocator"* @"??$move@AEAV?$allocator@D@std@@@std@@YA$$QEAV?$allocator@D@0@AEAV10@@Z"(%"class.std::allocator"* nonnull align 1 dereferenceable(1) %5) #12
...
declare dso_local void @"?_Locinfo_dtor@_Locinfo@std@@SAXPEAV12@@Z"(%"class.std::_Locinfo"*) #5
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.std::_Compressed_pair"* @"??$?0AEAPEAV_Facet_base@std@@@?$_Compressed_pair@U?$default_delete@V_Facet_base@std@@@std@@PEAV_Facet_base@2@$00@std@@QEAA@U_Zero_then_variadic_args_t@1@AEAPEAV_Facet_base@1@@Z"(%"class.std::_Compressed_pair"* returned %0, i8 %1, %"class.std::_Facet_base"** nonnull align 8 dereferenceable(8) %2) unnamed_addr #2 comdat align 2 {
  ...
  %9 = bitcast %"class.std::_Compressed_pair"* %8 to %"struct.std::default_delete"*
  %10 = getelementptr inbounds %"class.std::_Compressed_pair", %"class.std::_Compressed_pair"* %8, i32 0, i32 0
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 1 dereferenceable(1) %"struct.std::default_delete"* @"?_Get_first@?$_Compressed_pair@U?$default_delete@V_Facet_base@std@@@std@@PEAV_Facet_base@2@$00@std@@QEAAAEAU?$default_delete@V_Facet_base@std@@@2@XZ"(%"class.std::_Compressed_pair"* %0) #2 comdat align 2 {
  ...
  %4 = bitcast %"class.std::_Compressed_pair"* %3 to %"struct.std::default_delete"*
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?clear@?$basic_ios@DU?$char_traits@D@std@@@std@@QEAAXH_N@Z"(%"class.std::basic_ios"* %0, i32 %1, i1 zeroext %2) #0 comdat align 2 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca %"class.std::basic_ios"*, align 8
  %7 = zext i1 %2 to i8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?clear@ios_base@std@@QEAAXH_N@Z"(%"class.std::ios_base"* %0, i32 %1, i1 zeroext %2) #0 comdat align 2 {
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
...
26:                                               ; preds = %23
  call void @_CxxThrowException(i8* null, %eh.ThrowInfo* null) #17
  unreachable
...
39:                                               ; preds = %38, %31
  ...
  call void @_CxxThrowException(i8* %42, %eh.ThrowInfo* @"_TI5?AVfailure@ios_base@std@@") #17
  unreachable
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::ios_base::failure"* @"??0failure@ios_base@std@@QEAA@PEBDAEBVerror_code@2@@Z"(%"class.std::ios_base::failure"* returned %0, i8* %1, %"class.std::error_code"* nonnull align 8 dereferenceable(16) %2) unnamed_addr #0 comdat align 2 {
...
; Function Attrs: noinline uwtable
define internal void @"??__F_Static@?1???$_Immortalize_memcpy_image@V_Iostream_error_category2@std@@@std@@YAAEBV_Iostream_error_category2@1@XZ@YAXXZ"() #1 {
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?message@_Iostream_error_category2@std@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z"(%"class.std::_Iostream_error_category2"* %0, %"class.std::basic_string"* noalias sret align 8 %1, i32 %2) unnamed_addr #0 comdat align 2 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@QEBD_K@Z"(%"class.std::basic_string"* returned %0, i8* %1, i64 %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i64, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %"class.std::basic_string"*, align 8
  %7 = alloca %"struct.std::_Zero_then_variadic_args_t", align 1
...
declare dso_local i8* @"?_Syserror_map@std@@YAPEBDH@Z"(i32) #5
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::system_error"* @"??0system_error@std@@QEAA@Verror_code@1@PEBD@Z"(%"class.std::system_error"* returned %0, %"class.std::error_code"* %1, i8* %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::_System_error"* @"??0_System_error@std@@IEAA@Verror_code@1@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z"(%"class.std::_System_error"* returned %0, %"class.std::error_code"* %1, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %2) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca %"class.std::basic_string"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Makestr@_System_error@std@@CA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@Verror_code@2@V32@@Z"(%"class.std::basic_string"* noalias sret align 8 %0, %"class.std::error_code"* %1, %"class.std::basic_string"* %2) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %4 = alloca i8*, align 8
  %5 = alloca %"class.std::basic_string", align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@AEBV01@@Z"(%"class.std::basic_string"* returned %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1) unnamed_addr #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca %"class.std::basic_string"*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  ...
  %15 = load i8, i8* %14, align 1
  %16 = call %"class.std::_Compressed_pair.1"* @"??$?0V?$allocator@D@std@@$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_One_then_variadic_args_t@1@$$QEAV?$allocator@D@1@@Z"(%"class.std::_Compressed_pair.1"* %11, i8 %15, %"class.std::allocator"* nonnull align 1 dereferenceable(1) %5) #12
  ...
  %18 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %17, i32 0, i32 0
...
24:                                               ; preds = %2
  %25 = cleanuppad within none []
  call void @"??1?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@XZ"(%"class.std::_Compressed_pair.1"* %11) #12 [ "funclet"(token %25) ]
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@QEBD@Z"(%"class.std::basic_string"* %0, i8* %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  store i8* %1, i8** %3, align 8
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@AEBV12@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1) #0 comdat align 2 {
  %3 = alloca %"class.std::basic_string"*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
  store %"class.std::basic_string"* %1, %"class.std::basic_string"** %3, align 8
  store %"class.std::basic_string"* %0, %"class.std::basic_string"** %4, align 8
  ...
  %11 = load %"class.std::basic_string"*, %"class.std::basic_string"** %3, align 8
  %12 = getelementptr inbounds %"class.std::basic_string", %"class.std::basic_string"* %11, i32 0, i32 0
  %13 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %12, i32 0, i32 0
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?message@error_code@std@@QEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ"(%"class.std::error_code"* %0, %"class.std::basic_string"* noalias sret align 8 %1) #0 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::error_code"*, align 8
  %5 = bitcast %"class.std::basic_string"* %1 to i8*
  store i8* %5, i8** %3, align 8
...
define linkonce_odr dso_local %"class.std::basic_string"* @"??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@$$QEAV01@@Z"(%"class.std::basic_string"* returned %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1) unnamed_addr #2 comdat align 2 {
  ...
  %14 = load i8, i8* %13, align 1
  %15 = call %"class.std::_Compressed_pair.1"* @"??$?0V?$allocator@D@std@@$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_One_then_variadic_args_t@1@$$QEAV?$allocator@D@1@@Z"(%"class.std::_Compressed_pair.1"* %9, i8 %14, %"class.std::allocator"* nonnull align 1 dereferenceable(1) %12) #12
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@QEBD_K@Z"(%"class.std::basic_string"* %0, i8* %1, i64 %2) #0 comdat align 2 {
  %4 = alloca %"class.std::basic_string"*, align 8
  %5 = alloca i64, align 8
  %6 = alloca i8*, align 8
  %7 = alloca %"class.std::basic_string"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(32) %"class.std::basic_string"* @"??$_Reallocate_grow_by@V<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV34@QEBD_K@Z@PEBD_K@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV<lambda_1>@?0??append@01@QEAAAEAV01@QEBD0@Z@PEBD_K@Z"(%"class.std::basic_string"* %0, i64 %1, i8 %2, i8* %3, i64 %4) #0 comdat align 2 {
...
59:                                               ; preds = %33
  ...
  %68 = call i8* @"??$_Unfancy@D@std@@YAPEADPEAD@Z"(i8* %67) #12
  %69 = load i8*, i8** %18, align 8
  call void @"??R<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@QEBD_K@Z@QEBA?A?<auto>@@QEAD0101@Z"(%class.anon.8* %6, i8* %69, i8* %68, i64 %66, i8* %65, i64 %64)
  %70 = load %"class.std::allocator"*, %"class.std::allocator"** %16, align 8
  %71 = load i64, i64* %14, align 8
  %72 = add i64 %71, 1
  %73 = load i8*, i8** %19, align 8
...
78:                                               ; preds = %33
  ...
  %85 = getelementptr inbounds [16 x i8], [16 x i8]* %84, i64 0, i64 0
  %86 = load i8*, i8** %18, align 8
  call void @"??R<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@QEBD_K@Z@QEBA?A?<auto>@@QEAD0101@Z"(%class.anon.8* %6, i8* %86, i8* %85, i64 %81, i8* %80, i64 %79)
  %87 = load %"class.std::_String_val"*, %"class.std::_String_val"** %11, align 8
  %88 = getelementptr inbounds %"class.std::_String_val", %"class.std::_String_val"* %87, i32 0, i32 0
  %89 = bitcast %"union.std::_String_val<std::_Simple_types<char>>::_Bxty"* %88 to i8**
  call void @"??$_Construct_in_place@PEADAEBQEAD@std@@YAXAEAPEADAEBQEAD@Z"(i8** nonnull align 8 dereferenceable(8) %89, i8** nonnull align 8 dereferenceable(8) %17) #12
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local void @"??R<lambda_1>@?0??append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV23@QEBD_K@Z@QEBA?A?<auto>@@QEAD0101@Z"(%class.anon.8* %0, i8* %1, i8* %2, i64 %3, i8* %4, i64 %5) #2 comdat align 2 {
  %7 = alloca i64, align 8
  %8 = alloca i8*, align 8
  %9 = alloca i64, align 8
  %10 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local %"class.std::_Compressed_pair.1"* @"??$?0V?$allocator@D@std@@$$V@?$_Compressed_pair@V?$allocator@D@std@@V?$_String_val@U?$_Simple_types@D@std@@@2@$00@std@@QEAA@U_One_then_variadic_args_t@1@$$QEAV?$allocator@D@1@@Z"(%"class.std::_Compressed_pair.1"* returned %0, i8 %1, %"class.std::allocator"* nonnull align 1 dereferenceable(1) %2) unnamed_addr #2 comdat align 2 {
  %4 = alloca %"struct.std::_One_then_variadic_args_t", align 1
  %5 = alloca %"class.std::allocator"*, align 8
  %6 = alloca %"class.std::_Compressed_pair.1"*, align 8
  ...
  store %"class.std::_Compressed_pair.1"* %0, %"class.std::_Compressed_pair.1"** %6, align 8
  %8 = load %"class.std::_Compressed_pair.1"*, %"class.std::_Compressed_pair.1"** %6, align 8
  %9 = bitcast %"class.std::_Compressed_pair.1"* %8 to %"class.std::allocator"*
  ...
  %12 = getelementptr inbounds %"class.std::_Compressed_pair.1", %"class.std::_Compressed_pair.1"* %8, i32 0, i32 0
  %13 = call %"class.std::_String_val"* @"??0?$_String_val@U?$_Simple_types@D@std@@@std@@QEAA@XZ"(%"class.std::_String_val"* %12) #12
  ret %"class.std::_Compressed_pair.1"* %8
}
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Construct_lv_contents@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAXAEBV12@@Z"(%"class.std::basic_string"* %0, %"class.std::basic_string"* nonnull align 8 dereferenceable(32) %1) #0 comdat align 2 {
  %3 = alloca %"class.std::basic_string"*, align 8
  %4 = alloca %"class.std::basic_string"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?_Osfx@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAXXZ"(%"class.std::basic_ostream"* %0) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %2 = alloca %"class.std::basic_ostream"*, align 8
  store %"class.std::basic_ostream"* %0, %"class.std::basic_ostream"** %2, align 8
  %3 = load %"class.std::basic_ostream"*, %"class.std::basic_ostream"** %2, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_J@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, i64 %5) #0 comdat align 2 {
  %7 = alloca i8*, align 8
  %8 = alloca i64, align 8
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @"?put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@QEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DN@Z"(%"class.std::num_put"* %0, %"class.std::ostreambuf_iterator"* noalias sret align 8 %1, %"class.std::ostreambuf_iterator"* %2, %"class.std::ios_base"* nonnull align 8 dereferenceable(72) %3, i8 %4, double %5) #0 comdat align 2 {
  %7 = alloca i8*, align 8
  %8 = alloca double, align 8
  %9 = alloca i8, align 1
  %10 = alloca %"class.std::ios_base"*, align 8
  ...
  %22 = getelementptr inbounds void (%"class.std::num_put"*, %"class.std::ostreambuf_iterator"*, %"class.std::ostreambuf_iterator"*, %"class.std::ios_base"*, i8, double)*, void (%"class.std::num_put"*, %"class.std::ostreambuf_iterator"*, %"class.std::ostreambuf_iterator"*, %"class.std::ios_base"*, i8, double)** %21, i64 5
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i64 @"?sputn@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QEAA_JPEBD_J@Z"(%"class.std::basic_streambuf"* %0, i8* %1, i64 %2) #0 comdat align 2 {
  %4 = alloca i64, align 8
  %5 = alloca i8*, align 8
  %6 = alloca %"class.std::basic_streambuf"*, align 8
  store i64 %2, i64* %4, align 8
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @"?put@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAAAEAV12@D@Z"(%"class.std::basic_ostream"* %0, i8 %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i8, align 1
  %4 = alloca %"class.std::basic_ostream"*, align 8
  %5 = alloca i32, align 4
  %6 = alloca %"class.std::basic_ostream<char, std::char_traits<char>>::sentry", align 8
...
50:                                               ; preds = %29
  ...
  %52 = call zeroext i1 @"?eq_int_type@?$_Narrow_char_traits@DH@std@@SA_NAEBH0@Z"(i32* nonnull align 4 dereferenceable(4) %8, i32* nonnull align 4 dereferenceable(4) %7) #12
...
71:                                               ; preds = %57, %34, %32, %2
  ...
  call void @"??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QEAA@XZ"(%"class.std::basic_ostream<char, std::char_traits<char>>::sentry"* %6) #12 [ "funclet"(token %72) ]
  cleanupret from %72 unwind to caller
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8 @"?widen@?$basic_ios@DU?$char_traits@D@std@@@std@@QEBADD@Z"(%"class.std::basic_ios"* %0, i8 %1) #0 comdat align 2 personality i8* bitcast (i32 (...)* @__CxxFrameHandler3 to i8*) {
  %3 = alloca i8, align 1
...
; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local i8 @"?widen@?$ctype@D@std@@QEBADD@Z"(%"class.std::ctype"* %0, i8 %1) #0 comdat align 2 {
  %3 = alloca i8, align 1
  %4 = alloca %"class.std::ctype"*, align 8
  store i8 %1, i8* %3, align 1
  store %"class.std::ctype"* %0, %"class.std::ctype"** %4, align 8
...
attributes #1 = { noinline uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #4 = { noinline noreturn optnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #6 = { nobuiltin allocsize(0) "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #13 = { nobuiltin noinline nounwind optnone readnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #14 = { nobuiltin noinline nounwind optnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
